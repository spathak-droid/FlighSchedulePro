...
export default function AuthenticatedLayout({ children }: { children: React.ReactNode }) {
  ...
  // Sidebar nav items stagger animation on mount
  useEffect(() => {
    ...
    <div className="app-shell">
      ...
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`}>
        <div className="sidebar-header">
          <span className="sidebar-logo">FSP</span>
          <span className="sidebar-logo-text">Scheduler</span>
          <button
        ...
        <div className="sidebar-activity">
          <ActivityFeed compact refreshInterval={60000} />
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div className="sidebar-user-details">
              <div className="sidebar-user-email">{userEmail || 'User'}</div>
      ...
      <div className="app-main">
        <header className="app-topbar">
          ...
          <span className="app-topbar-title">{currentPage?.label || 'FlightSchedule Pro'}</span>
        </header>
